...
class Liikennevaylat(GisProcessor):
    ...
    def _clipAreasByAreasYlreKatualueet(self, geometryToClip: gpd.GeoDataFrame, mask: gpd.GeoDataFrame, geometryToClipAttrsDissolve, maskAttrsDissolve, mergeIdField, geometryToClipCheckAttr=None) -> gpd.GeoDataFrame:
        geometry = geometryToClip[~geometryToClip.is_empty]
        ...
        for attr in geometryToClipAttrsDissolve:
            clipped_result[attr] = clipped_result[attr].fillna("")
    ...
    def process(self):
        ...
        target_infra_polys = self._clipAreasByAreasYlreKatualueet(target_infra_polys, self._ylre_katualueet, geometryToClipAttrsDissolve, maskAttrsDissolve, "id", "ylre_class")
